		...
		<div class="container">
			<div class="row map_row">
				<div class="col">
					...
					<input type=text name=cari></input><input type=submit>
					</form>
					<!--kos data-->
					<table >
						<tr>
						...
						include 'conn.php';
						$alamat="";
						if(isset($_POST["cari"])$alamat=$_POST["cari"];
						$no = 1;
						$sql = mysqli_query($db,"select * from dk where alamat=%".$alamat."%");
						while($data = mysqli_fetch_array($sql)){
						?>
						<tr>
							<td><?php echo $no++; ?></td>
							<td><?php echo $data['dk_nama']; ?></td>
							<td><?php echo $data['dk_alamat']; ?></td>
							<td><?php echo "<a href=kosdetil.php?dk_id=".$data[dk_id].">link ke kos</a>"; ?></td>
						</tr>
						<?php 
						}
						?>
